...
# Two trajectories are single committed CSVs (+ JSON meta), each generated by
# rerunning the main config with its own instrumentation: the progress measures
# (§10) and the attention read-out (appendix).
